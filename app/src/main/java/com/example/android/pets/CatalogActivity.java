...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            int nameColumnIndex = cursor.getColumnIndex(PetEntry.COL_PET_NAME);
            int breedColumnIndex = cursor.getColumnIndex(PetEntry.COL_PET_BREED);
            int genderColumnIndex = cursor.getColumnIndex(PetEntry.COL_PET_GENDER);
            int weightColumnIndex = cursor.getColumnIndex(PetEntry.COL_PET_WEIGHT);
